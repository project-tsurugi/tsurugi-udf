...
class PacGreeterServiceImpl final : public dog::cat::mouse::Pac::Service {
    Status PacSayHello(
        ServerContext* context,
        const dog::cat::mouse::StringValue* request,
        dog::cat::mouse::StringValue* reply
    ) override {
    ...
    Status
    PacIntAddInt(ServerContext* context, const dog::cat::mouse::Int32Value* request, dog::cat::mouse::Int32Value* reply)
        override {
...
class PacByerServiceImpl final : public dog::cat::mouse::Byer::Service {
    Status PacSayWorld(
        ServerContext* context,
        const dog::cat::mouse::StringValue* request,
        dog::cat::mouse::StringValue* reply
...
void RunServer(const std::string& server_address, const std::string& secure) {
    PacGreeterServiceImpl greeter_service;
    PacByerServiceImpl byer_service;
