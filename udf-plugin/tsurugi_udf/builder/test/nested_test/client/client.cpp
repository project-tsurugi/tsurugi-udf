...
int main(int argc, char** argv) {
    ...
    if(argc >= 2) {
        ...
        try {
            ...
            grpc_endpoint = pt.get<std::string>("udf.endpoint", grpc_endpoint);
    ...
    auto channel = grpc::CreateChannel(grpc_endpoint, grpc::InsecureChannelCredentials());
